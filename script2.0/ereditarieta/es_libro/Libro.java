/*Creare un sistema che permetta di salvare i vari oggetti libro che creo e che permetta a un oggetto utente( Nome, Password, id )
 tramite l'inserimento della sua password per conferma di prendere un libro in prestito */
package es_libro;
...
public class Libro {
    public static void main(String[] args) {
        ...
        Utentestr utente = new Utentestr("Ambarabaciccicocco", "ambara123", 1);
